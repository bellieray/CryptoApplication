package com.feature.detail.dialog
...
import com.feature.detail.R
import com.feature.detail.RefreshTimeAdapter
...
class RefreshTimeBottomSheetDialog(val onDismissed: () -> Unit, val onValueGet: (String) -> Unit) :
    ...
    private var _binding: com.feature.detail.databinding.DialogRefreshTimeBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = com.feature.detail.databinding.DialogRefreshTimeBinding.inflate(
            layoutInflater,
            container,
            false
        )
